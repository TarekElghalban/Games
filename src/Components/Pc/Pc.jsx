...
<div className="row mt-lg-5 gx-5 gy-3 py-lg-5 py-lg-5 mt-5 pt-5">
  {Platform.filter(game => game.platform = "PC (Windows)").slice(0,count).map((game , index)=> <div key={index} className="col-md-3 card-list "><Link to={`/GamesDetails/${game.id}`}> <div className="card shadow" >
