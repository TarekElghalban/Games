...
export default function Action() {
  ...
  {category.filter(category => category.genre === "MOBA").slice(0,count).map((game , index)=> <div key={index} className="col-md-3 card-list "><Link to={`/GamesDetails/${game.id}`}> <div className="card shadow" >
